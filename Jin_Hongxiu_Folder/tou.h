...
// 最终版查询函数声明（仅精确/简单匹配）
void cx_by_shijian_jiandan(const char* rq);//时间简单
void cx_by_jine_jiandan(const char* je);//金额简单
void cx_by_shijian_mohu(const char* gj);//时间模糊
void cx_by_jine_mohu(const char* gj);//金额模糊
